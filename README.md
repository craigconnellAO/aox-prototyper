...
2. **Copy the skills in.** `cp -r skills/* <your-workspace>/.kiro/skills/` — this is the step people miss, and without it `/ideate-mode` and the Figma bridge aren't available. (optional for now)
